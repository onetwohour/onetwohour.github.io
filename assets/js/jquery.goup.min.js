...
window.addEventListener('scroll', function() {
    var buttons = this.document.querySelectorAll('.goup-container');
    ...
    buttons.forEach(function(botton){
        ...
        button.style.top = (windowHeight - buttonHeight - 20 + scrollPosition) + 'px';
        button.style.left = (windowWidth - buttonWidth - 20) + 'px';
    });
});
